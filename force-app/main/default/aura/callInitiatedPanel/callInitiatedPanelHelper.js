...
({
    ...
    screenPopAndCall : function(cmp) {
        console.log('screenPopAndCall');
        if (cmp.get('v.state') == 'Dialing') {
    ...
    renderConnectedPanel : function(cmp){
        // console.log('renderConnectedPanel');
    ...
    // on Outgoing, force customer to answer a call
    renderConnectedPanel2 : function(cmp){
        console.log('renderConnectedPanel2');
        var recordId = cmp.get('v.recordId');
        var account = cmp.get('v.account');
        console.log('recordId=',recordId);
        console.log('accountId=',account.Id);
